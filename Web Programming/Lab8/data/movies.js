...
export const searchMoviesByName = async (title) => {
  ...
  */
  ...
  let movies = [];
  let pageOne = await axios.get('http://www.omdbapi.com/?apikey=CS546&s=' + title);
  ...
  // get page two
  let pageTwo = await axios.get('http://www.omdbapi.com/?apikey=CS546&s='+ title +'&page=2')
...
export const searchMovieById = async (id) => {
 ...
 let movie = await axios.get('http://www.omdbapi.com/?apikey=CS546&i=' + id);
