...
# register usage: r1 for input, r5 for output

0       read     r1           # Get n
1       jeqzn    r1 20        # jump to halt if r1 is 0
2       setn     r2 0         # initialize r2
3       setn     r3 1         # initialize r3
4       setn     r4 0         # initialize r4
5       write    r2           # prints r2
6       addn     r1 -1        # subtract 1 from r1
7       jeqzn    r1 20        # jump to halt if r1 is 0
8       write    r3           # prints r3
9       addn     r1 -1        # subtract 1 from r1
10      jeqzn    r1 20        # jump to halt if r1 is 0
11      add      r2 r2 r3     # change r2 = r2 + r3
12      write    r2           # prints r2
13      addn     r1 -1        # subtract 1 from r1
14      jeqzn    r1 20        # jump to halt if r1 is 0
15      add      r3 r2 r3     # change r3 = r2 + r3
16      write    r3           # prints r3
17      addn     r1 -1        # subtract 1 from r1
18      jeqzn    r1 20        # jump to halt if r1 is 0
19      jumpn    11           # repeat
