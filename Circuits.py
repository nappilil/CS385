...
def test_fourBitAdd():
    ...
    nine = (0,1,0,1)
    ten = (0,1,1,0)
    c,wwww = fourBitAdd(zero,zero)
    assert( wwww == (0,0,0,0) and c == 0 )
    c,wwww = fourBitAdd(one,zero)
    assert( wwww == (0,0,0,1) and c == 0 )
    c,wwww = fourBitAdd(two,zero)
    assert( wwww == (0,0,1,0) and c == 0 )
    c,wwww = fourBitAdd(three,zero)
    assert( wwww == (0,0,1,1) and c == 0 )
    c,wwww = fourBitAdd(four,four)
    assert( wwww == (0,1,0,0) and c == 1 )
    c,wwww = fourBitAdd(five,five)
    assert( wwww == (1,1,0,0) and c == 1 )
    c,wwww = fourBitAdd(six,nine)
    assert( wwww == (0,0,0,0) and c == 1 )
    c,wwww = fourBitAdd(seven,one)
    assert( wwww == (0,0,1,1) and c == 0 )
    c,wwww = fourBitAdd(eight,ten)
    assert( wwww == (0,1,0,1) and c == 1 )
    print("test_fourBitAdd worked (complete test)")
